...
4. Откройте PR с описанием мотивации и ссылкой на ADR (если меняется архитектура — добавьте запись в `decisions/`).
5. Дождитесь ревью и CI.

## ADR

Любое решение, меняющее архитектуру железа/софта/бизнеса — запись в `decisions/` (формат см. `decisions/README.md`).
